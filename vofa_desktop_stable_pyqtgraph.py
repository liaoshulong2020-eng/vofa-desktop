...
"""
==============================================================================
 VOFA+ Native Desktop Stable Version (PyQtGraph C++ OpenGL Edition)
 Saved Milestone Version: 2026-07-24
 ==============================================================================
"""
...
class VofaDesktopApp(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("VOFA+ Native Desktop Pro | 伏特加上位机 (PyQtGraph C++ 硬件加速稳定版)")
